local qiaosi = fk.CreateSkill{
  name = "fengsui_heg__qiaosiRemake",
}

local discarded_mark = "fengsui_heg__qiaosiRemake_discarded-turn"
...
qiaosi:addEffect(fk.EventPhaseStart, {
  anim_type = "support",
  can_trigger = function(self, event, target, player, data)
    return target == player and player:hasSkill(qiaosi.name) and
      player.phase == Player.Finish and table.find(player:getTableMark(discarded_mark), function(id)
  ...
  on_cost = function(self, event, target, player, data)
    ...
    local choices = {}
    local mapping = {
      [Card.TypeBasic] = "fengsui_heg__qiaosiRemake_basic",
      [Card.TypeTrick] = "fengsui_heg__qiaosiRemake_trick",
      [Card.TypeEquip] = "fengsui_heg__qiaosiRemake_equip",
    }
    ...
    local choice = room:askToChoice(player, {
      ...
      prompt = "#fengsui_heg__qiaosiRemake-choice",
      cancelable = true,
    })
  ...
  on_use = function(self, event, target, player, data)
    ...
    local mapping = {
      fengsui_heg__qiaosiRemake_basic = Card.TypeBasic,
      fengsui_heg__qiaosiRemake_trick = Card.TypeTrick,
      fengsui_heg__qiaosiRemake_equip = Card.TypeEquip,
    }
