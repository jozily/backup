...
local chizhijian2 = fk.CreateSkill{
  name = "chizhijian2",
}
local OPT_MARK = "chizhijian2_options-round"
...
chizhijian2.addZhijianOnce = function(room, player, expected_delta)
  local opts = player:getTableMark(OPT_MARK)
  ...
  if true then
    ...
    local a2, b2 = zhijian_pick_manual_two(room, player, opts, "chizhijian2")
    a, b = a2, b2
...
chizhijian2:addAcquireEffect(function(self, player, is_start)
  zhijian_init_opts(player, OPT_MARK, 2)
end)

chizhijian2:addEffect(fk.EventPhaseStart, {
  anim_type = "control",
  can_trigger = function(self, event, target, player, data)
    return target == player and player:hasSkill(chizhijian2.name) and player.phase == Player.Start and #player:getTableMark(OPT_MARK) >= 2
  end,
...
chizhijian2:addEffect("targetmod", {
...
chizhijian2:addEffect(fk.RoundStart, {
  can_refresh = function(self, event, target, player, data)
    return player:hasSkill(chizhijian2.name, true)
  end,
