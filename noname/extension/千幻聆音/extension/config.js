...
export let CONFIG = {
	...
	"qhly_replaceCharacterCard2": {
		...
		"init": lib.config.qhly_replaceCharacterCard2 === undefined ? 'info' : lib.config
			.qhly_replaceCharacterCard2,
		"item": {
			'nonereplace': '不替换',
	...
	"qhly_smallwinclosewhenchange": {
		...
		"init": lib.config.qhly_smallwinclosewhenchange === undefined ? false : lib.config
			.qhly_smallwinclosewhenchange,
		onclick: function(item) {
	...
	"qhly_originSkinPath": {
		"name": "本体武将皮肤目录",
		"intro": "可设置本体武将的皮肤目录。",
		"init": lib.config.qhly_originSkinPath === undefined ? "extension/千幻聆音/sanguoskin/" : lib.config
			.qhly_originSkinPath,
		"item": {
	...
	"qhly_keymarkopen": {
		...
		onclick: function(item) {
			...
			if (item) {
				...
				if (!ori) {
					ori =
						"锁定技:blue;限定技:orange;觉醒技:red;使命技:gold;#出牌阶段:#00FF00;#摸牌阶段:#00FF00;#弃牌阶段:#00FF00;#准备阶段:#00FF00;#结束阶段:#00FF00;";
				}
				// @ts-ignore
	...
	"qhly_decadeDengjie": {
		"name": "小窗人物等阶",
		"init": lib.config['extension_千幻聆音_qhly_decadeDengjie'] === undefined ? "auto" : lib.config[
			'extension_千幻聆音_qhly_decadeDengjie'],
		"item": {
			"one": "一阶",
			"two": "二阶",
			"three": "三阶",
	...
	"qhly_decadeAuto": {
		"name": "自动换肤间隔",
		"intro": "调节自动换肤时间",
		"init": lib.config['extension_千幻聆音_qhly_decadeAuto'] === undefined ? "30" : lib.config[
			'extension_千幻聆音_qhly_decadeAuto'],
		"item": {
			"10": "每10秒",
			"30": "每半分钟",
			"60": "每1分钟",
